...
const ItemList = ({  items }) => {
  ...
  return (
    <div>
      ...
      <div className="hidden w- mb-4 tab:grid gap-x-4 gap-y-6 tab:grid-cols-itemListDesk">
      ...
      {/* items */}
      <div className="grid gap-y-12 tab:gap-y-5">
        {items?.map((item, i) => {
          let isErrorName = {
            isError: false,
            msg: "",
          ...
          return (
            ...
            >
              <div className="relative w-full col-start-1 col-end-13 tab:col-start-1 tab:col-end-2">
                <label
                  className={`text-xs font-medium leading-heading4 tracking-heading4 tab:hidden ${
                    isErrorName?.isError
                      ? "text-deleteBtn"
              ...
              <div className="w-full col-start-8 col-end-13 tab:col-start-4 tab:col-end-5">
                <h4 className="dark:text-shadedTextDark tab:hidden">Total</h4>
                <div className="flex justify-between items-center py-3">
                  ...
                  >
                    <IconDelete className="fill-textReallyDark hover:fill-deleteBtn" />
                  </button>
                </div>
              </div>
            </div>
