...
const BillTo = ({ setInvoiceFormValues, clientAddress, clientName, clientEmail }) => {
  return (
    <div className="grid grid-cols-6 pb-16">
      ...
      <ClientsDets clientDets={{setInvoiceFormValues,clientName,clientEmail}} {...clientAddress} />
      <InvoiceDets />
    </div>
  );
};
